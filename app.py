...
senioridade_selecionadas = st.sidebar.multiselect('Senioridade', 
senioridades_disponiveis, default=senioridades_disponiveis)
...
#filtragem do DataFrame. O df principal é filtrado com base nas seleções feitas na barra lateral
df_filtrado = df[
...
#isin verifica se os valores da coluna estão nos valores selecionados na barra lateral
...
#.shape[0] retorna o número de linhas no DataFrame filtrado
